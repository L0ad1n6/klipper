...
SOURCE_FILES = [
    ...
    'kin_extruder.c', 'kin_shaper.c', 'kin_idex.c', "kin_tachyon.c"
]
...
defs_kin_tachyon = """
    struct stepper_kinematics *tachyon_stepper_alloc(char type);
"""
...
defs_all = [
    ...
    defs_kin_extruder, defs_kin_shaper, defs_kin_idex, defs_kin_tachyon
]
