...
static double
tachyon_stepper_mult_calc_position(struct stepper_kinematics *sk, struct move *m
                                   , double move_time)
{
...
static double
tachyon_stepper_div_calc_position(struct stepper_kinematics *sk, struct move *m
                                   , double move_time)
{
...
tachyon_stepper_alloc(char type)
{
    ...
    if (type == '+')
        ...
        sk->calc_position_cb = tachyon_stepper_mult_calc_position;
    else if (type == '/')
        sk->calc_position_cb = tachyon_stepper_div_calc_position;
